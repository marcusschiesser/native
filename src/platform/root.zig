...
pub const min_audio_capture_buffer_duration_ms = types.min_audio_capture_buffer_duration_ms;
pub const max_audio_capture_buffer_duration_ms = types.max_audio_capture_buffer_duration_ms;
pub const audio_capture_block_duration_ms = types.audio_capture_block_duration_ms;
pub const audio_capture_max_read_duration_ms = types.audio_capture_max_read_duration_ms;
...
pub const AudioCaptureFramePair = types.AudioCaptureFramePair;
