...
pub const EffectCredentialOp = runtime_effects.EffectCredentialOp;
pub const EffectCredentialOutcome = runtime_effects.EffectCredentialOutcome;
pub const EffectCredentialResult = runtime_effects.EffectCredentialResult;
pub const max_effect_credential_service_bytes = runtime_effects.max_effect_credential_service_bytes;
pub const max_effect_credential_account_bytes = runtime_effects.max_effect_credential_account_bytes;
pub const max_effect_credential_secret_bytes = runtime_effects.max_effect_credential_secret_bytes;
