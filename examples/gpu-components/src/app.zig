...
pub const GpuComponentsApp = struct {
    ...
    fn event(context: *anyopaque, runtime: *native_sdk.Runtime, event_value: native_sdk.Event) anyerror!void {
        ...
        switch (event_value) {
            ...
            .gpu_surface_resized, .gpu_surface_input, .shortcut, .timer, .effects_wake, .audio, .audio_capture, .microphone_device, .microphone_devices_changed, .audio_capture_access, .video, .files_dropped, .canvas_widget_file_drop, .canvas_widget_drag, .canvas_widget_context_menu, .canvas_widget_context_menu_shown, .canvas_widget_context_menu_dismissed, .canvas_widget_context_menu_request, .canvas_widget_context_press, .canvas_widget_resize, .canvas_widget_change, .window_closed, .automation_provenance, .lifecycle => {},
        }
    }
