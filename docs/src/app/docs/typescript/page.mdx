...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>Cmd.audioCaptureStart</code> / <code>audioCaptureRead</code> / <code>audioCaptureStop</code> / <code>audioCaptureDiscard</code> / microphone device and access commands</td>
      <td>macOS 15+ reliable paired s16le PCM, microphone enumeration, and explicit permission status/request operations; see <a href="/docs/audio-capture">Audio Capture</a></td>
    </tr>
    <tr>
