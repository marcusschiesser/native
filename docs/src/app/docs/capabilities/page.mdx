...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>Cmd.credentialSet(...)</code> / <code>credentialGet(...)</code> / <code>credentialDelete(...)</code>; Zig <code>UiApp</code>: <code>fx.setCredential</code> / <code>fx.getCredential</code> / <code>fx.deleteCredential</code>; runtime equivalents</td>
      ...
      <td>macOS model cores, system WebView, and Chromium through Keychain; Linux model cores and system WebView through Secret Service/libsecret when available; Windows model cores and system WebView through Credential Manager</td>
    </tr>
    <tr>
