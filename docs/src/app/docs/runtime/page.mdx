...
See [Frontend Projects](/docs/frontend) for the dev-server/bundled-assets workflow.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>null</code></td>
      <td>App-defined bridge commands and handlers (WebView apps; see <a href="/docs/bridge">Bridge</a>)</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>showWindow(id) !void</code></td>
      <td>Un-hide and activate a window (the counterpart to a <code>close_policy = "hide"</code> hide; also restores a minimized window)</td>
    </tr>
    <tr>
      <td><code>quitApp() !void</code></td>
      <td>Quit gracefully through the same shutdown path a last-window close takes</td>
    </tr>
    <tr>
